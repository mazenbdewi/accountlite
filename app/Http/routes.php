...
Route::get('/adminpanel/products/data',['as'=>'adminpanel.products.data','uses'=>'ProductController@anyData']);
Route::get('/adminpanel/products/editData',['as'=>'adminpanel.products.editData','uses'=>'ProductController@update']);
Route::get('/adminpanel/inv/Datainv',['as'=>'adminpanel.inv.Datainv','uses'=>'InvoiceController@Datainv']);
Route::get('/adminpanel/inv/Datainvbuy',['as'=>'adminpanel.inv.Datainvbuy','uses'=>'InvoiceController@Datainvbuy']);
Route::get('/adminpanel/inv/Datainvall',['as'=>'adminpanel.inv.Datainvall','uses'=>'InvoiceController@Datainvall']);
...
Route::get('/adminpanel/accounts/showDebt','AccountController@showDebt');
...
Route::get('/adminpanel/inv/findcust','InvoiceController@findCustomer');
Route::get('/adminpanel/inv/findqty','InvoiceController@findQty');
...
Route::get('/adminpanel/invbuy/{id}','InvoiceController@show');
...
Route::get('/adminpanel/invbuy/','InvoiceController@index3');
Route::get('/adminpanel/invall/','InvoiceController@index4');
