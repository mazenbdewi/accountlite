...
class CustomerController extends Controller
{
    ...
    public function index()
    {
       ...
       return view('admin.customers.index')->with('customers',$customers)->with('orders',$orders) ; 
    }
    ...
    public function show($id)
    {
       $orders= DB::table('orders')->join('customers','customers.id','=','orders.customer_id')
                              ...
                              ->select('orderType','orderPayment','orderDate','backMoney','getMoney','customers.customerDebt','orders.id')
      ...
      $orderCustomers=DB::table('customers')
        ...
        $limits=DB::table('customers')->where('customers.id','=',$id)->select('limit')->get();
         ...
         return view('admin.customers.debt')->with('orders',$orders)->with('orderCustomers',$orderCustomers)
     ...
     
    {
        $orders= DB::table('orders')->join('customers','customers.id','=','orders.customer_id')
                               // ->join('numbersell','numbersell.order_id','=','orders.id')
                              ->select('orderType','orderPayment','fromto','orderDate','backMoney','getMoney','customers.customerDebt','orders.id')
                              ->where('orders.customer_id','=',$id)
                              ->get();
        ...
        $limits=DB::table('customers')->where('customers.id','=',$id)->select('limit')->get();
         ...
         return view('admin.customers.printdebt')->with('orders',$orders)->with('moneyLimit',$moneyLimit)
                                                 ->with('cust',$cust);
    }
