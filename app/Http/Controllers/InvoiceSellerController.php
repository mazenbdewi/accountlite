...
class InvoiceSellerController extends Controller
{
...

    {
        ...
        return view('seller.inv.index')->with('orders',$orders);
    }
    ...
    public function show($id)
    {
       ...
       // $orders = DB::table('orders')->select('id','orderDate','orderType')->where('id',$id)->get();
        ...
        return view('seller.inv.bill')->with('order',$order)
    ...
    public function form()
    {
       ...
       $q= DB::table('products')->get();
        ...
        return view('seller.inv.form')->with('data',$q)->with('catch3',$catch3)->with('car',$car)
    ...
    public function save(Request $request)
    {
      ...
      DB::transaction(function() use($request){ 
        ...
        if($j>0)
        {
          ...
          return redirect('/seller/inv/form'); 
...
public function reform()
    {
        ...
        $q= DB::table('products')->get();
        return view('admin.inv.reform')->with('data',$q)->with('id',$id)->with('customer',$customer);
    }
 ...
 public function formOut()
    ...
    public function showbuy($id)
    {
       ...
       // $orders = DB::table('orders')->select('id','orderDate','orderType')->where('id',$id)->get();
        ...
        return view('seller.inv.billsell')->with('order',$order)
                                     ->with('employees',$employees)
                                     ->with('orderCustomers',$orderCustomers)
...

    {
       ...
       // $orders=Order::all();
        ...
        return view('seller.inv.index2')->with('orders',$orders);
    }
