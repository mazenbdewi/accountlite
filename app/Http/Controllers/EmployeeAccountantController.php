...
class EmployeeAccountantController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        $careers=Career::lists('careerName', 'id');
        return view('accountant.employees.index')->with('careers', $careers)->with('employees',$employees);
    }
 ...
 $employees=DB::table('employees')
         ...
         return view('accountant.employees.debt')->with('orders',$orders)->with('employees',$employees);
    ...
    public function edit($id , Employee $employee)
    {
        ...
        return view('accountant.employees.edit')->with('employee',$employee)->with('careers', $careers);
    }
    ...
    {  
      ...
      return view ('accountant.employees.print')->with('employees',$employees)  ;
    }  
 ...
 $employees=DB::table('employees')
         ...
         return view('accountant.employees.printdebt')->with('orders',$orders)->with('employees',$employees);
