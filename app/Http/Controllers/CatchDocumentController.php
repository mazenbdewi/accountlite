...
use App\Customer ;
use App\Employee ;
class CatchDocumentController extends Controller
{
    /**
    ...
    public function index()
    {
         ...
         return view('admin.catchDocuments.add');
