...
class InvoiceSellerOutController extends Controller
{
...

    {
        ...
        return view('sellerOut.inv.index')->with('orders',$orders);
    }
    ...
    public function show($id)
    {
       ...
       // $orders = DB::table('orders')->select('id','orderDate','orderType')->where('id',$id)->get();
        ...
        return view('sellerOut.inv.bill')->with('order',$order)
    ...
    public function form()
    {
       ...
       $q= DB::table('products')->get();
        ...
        return view('sellerOut.inv.form')->with('data',$q)->with('catch3',$catch3)
    ...
    public function save(Request $request)
    {
      ...
      DB::transaction(function() use($request){ 
        ...
        if($j>0)
        {
          ...
          return redirect('/sellerout/inv/form'); 
...

    {
        ...
        $q= DB::table('products')->get();
        return view('seller.inv.formbuy')->with('data',$q)->with('id',$id)->with('provider',$provider);
    }
    ...
    public function savebuy(Request $request)
    {
       ...
       DB::transaction(function() use($request){
        ...
        $l=DB::table('orderdetails')->join('products','orderdetails.product_id','=','products.id')
          ...
          return redirect('/seller/inv/formbuy'); 
...
public function reform()
    {
        ...
        $q= DB::table('products')->get();
        return view('sellerOut.inv.reform')->with('data',$q)->with('id',$id)->with('customer',$customer);
    }
    ...
    public function resave(Request $request)
    {
        ...
        $l=DB::table('orderdetails')->join('products','orderdetails.product_id','=','products.id')
          ...
          return redirect('/sellerout/inv/reform'); 
 ...
 public function formOut()
    ...
    public function showbuy($id)
    {
       ...
       // $orders = DB::table('orders')->select('id','orderDate','orderType')->where('id',$id)->get();
        ...
        return view('sellerout.inv.billsell')->with('order',$order)
                                     ->with('employees',$employees)
                                     ->with('orderCustomers',$orderCustomers)
...

    {
       ...
       // $orders=Order::all();
        ...
        return view('sellerout.inv.index2')->with('orders',$orders);
    }
