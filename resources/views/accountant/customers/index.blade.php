...
@section('content')
  ...
  <div class="modal-content">
      ...
      {!! Form::open(["url"=>"/accountant/customers" , "method"=>"POST"]) !!}
            @include('accountant.customers.form')
         ...
         <div class="panel-body">
              <table id="data" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><a href="{{url('/accountant/customers/'.$customer->id.'/edit')}}">
                  <span class="glyphicon glyphicon-pencil"></span></a>  </td>
                   <td> <a href="/accountant/customers/{{$customer->id}}" class="btn btn-default"> كشف حساب </a></td>
