...
جدول الفواتير 
            ...
            <section>
            <table>
              {!! Form::open(['Route'=>'accountant.inv.index','method'=>'GET','class'=>'Class_name']) !!}
              <td>............................................................................</td>
                ...
                <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td width="15%"><span ><?php  if($order->orderType=='sell') echo 'بيع' ;
                                       elseif($order->orderType=='sellOut') echo 'بيع مندوب';
                                ...
                                ?></span></td>
                     <td width="15%"> <a href="/accountant/inv/{{$order->id}}" target="_blank" class="btn btn-default"> الفاتورة </a></td>
