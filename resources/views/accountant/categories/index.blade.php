...
@section('content')
  ...
  <div class="modal-content">
                              ...
                              <h2><br/> انشاء نوع جديد </h2><hr/>
                                  ...
                                  {!! Form::open(["url"=>"/accountant/categories" , "method"=>"POST" ]) !!}
                                 ...
                                 @if($categories !=null)
                                    ...
                                    <table class="table">
                                              ...
                                              <tr>
                                                  ...
                                                  {!! Form::open(["url"=>"/accountant/categories/$category->id" , "method"=>"PATCH" ]) !!}

                                                <td>    {!! Form::text("categoryName",$category->categoryName,array('readonly','class'=>'form-control')) !!} </td>
                                                   
                                                    <td>
                                                   {!! Form::open(["url"=>"/accountant/categories/$category->id" , "method"=>"delete" ]) !!}
