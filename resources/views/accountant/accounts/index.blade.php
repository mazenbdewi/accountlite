            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  <thead>
                  {!! Form::open(['Route'=>'accountant.accounts.index','method'=>'GET','class'=>'Class_name']) !!}
                  ...
                  <tr>
                    ...
                    <td><span ><?php  if($order->orderType=='sandin') echo 'سند قبض' ;
                                ...
                                ?></span></td>
                     <td> <a href="/accountant/accounts/{{$order->id}}" target="_blank" class="btn btn-default"> الفاتورة </a></td>
                  </tr>
