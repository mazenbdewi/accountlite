...
#orderBankName,#orderCheckNO,#employee,#provider,#customer{
display: none ;
...
<div>@foreach($catch as $catchs)
  <a href='/accountant/inv/{{$catchs->id}}' target="_blank"><span class="glyphicon glyphicon-print"></span></a> 
@endforeach 
</div>
...
<tr>
 ...
 <td>{!!  Form::number("orderOutPayment",null,array('required'=>'','id'=>'orderOutPayment','class'=>'form-control','placeholder'=>'المبلغ'))!!}</td>
