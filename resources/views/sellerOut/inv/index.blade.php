...
جدول الفواتير 
            ...
            <section>
             <table>
              {!! Form::open(['Route'=>'sellerOut.inv.index','method'=>'GET','class'=>'Class_name']) !!}
              <td>............................................................................</td>
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td width="15%"><span ><?php  if($order->orderType=='sellOut') echo 'بيع' ;
                                   
                                     
                                      elseif($order->orderType=='resellout') echo 'مرتجع مبيعات';
                                    
                                ?></span></td>
                     <td width="15%"> <a href="/sellerout/inv/{{$order->id}}" target="_blank" class="btn btn-default"> الفاتورة </a></td>
