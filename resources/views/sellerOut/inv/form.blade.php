...
<td>فاتورة بيع</td>
   ...
   <div>
        @foreach($catch3 as $catchs3)
         <a href='/sellerout/inv/{{$catchs3->id}}' target="_blank"><span class="glyphicon glyphicon-print"></span></a> 
         <a href='/sellerout/invsell/{{$catchs3->id}}' target="_blank"><span class="glyphicon glyphicon-edit"></span></a> 
  ...
  <form  name="ordersave" action="{{action('InvoiceSellerOutController@save')}}" onsubmit="return validateForm()" method="post">
  <input type="hidden" name="_token" value="<?= csrf_token() ; ?>" >

  
  <table class="table table-striped" style="direction:rtl">
                            <tr>
                             <input type="hidden" name="orderType" value="sellOut">
                            </tr>
                            <tr>
                   ...
                   echo "<td><span><input type='text' name='employeeName'  value='$employeeName' class='form-control' readonly /></span></td>" ;
                              ...
                              ?>
         <td><span> {!! Form::select('customer_id', $customer,null,array('class' => 'form-control' ,'placeholder' => 'الزبون','required'=>'required')) !!}</span></td>
