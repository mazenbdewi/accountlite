...
<td>فاتورة بيع</td>
   ...
   <div>
        @foreach($catch3 as $catchs3)
         <a href='/seller/inv/{{$catchs3->id}}' target="_blank"><span class="glyphicon glyphicon-print"></span></a> 
        <a href='/seller/invsell/{{$catchs3->id}}' target="_blank"><span class="glyphicon glyphicon-edit"></span></a> 
  ...
  <form  name="ordersave" action="{{action('InvoiceSellerController@save')}}" onsubmit="return validateForm()" method="post">
  ...
  <table class="table table-striped" style="direction:rtl">
                   ...
                   echo "<td><span><input type='text' name='employeeName'  value='$employeeName' class='form-control' readonly /></span></td>" ;
                    ...
                    <tr>
                       ...
                       <td id="new"><a href="/seller/cars">سيارة جديدة</a></td>
