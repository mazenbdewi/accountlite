...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/buttons/1.2.4/css/buttons.dataTables.min.css">
 ...
 <script type="text/javascript">
  ...
  var table = $('#data').DataTable( {
        ...
        "ajax":'{{ url('/adminpanel/inv/Datainvbuy') }}',

        columns: [
             
                {data: 'numberBuyId', name: 'numberBuyId'},
                {data: 'providerFirstName', name: 'providerFirstName'},
                {data: 'providerLastName', name: 'providerLastName'},
