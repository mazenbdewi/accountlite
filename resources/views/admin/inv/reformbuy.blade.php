...
<section class="content"  style="direction:rtl">
      <div class="row">
        ...
        <div class="panel-heading">فاتورة مردود شراء</div>
         <div>
    @foreach($id as $id1)
         <a href='/adminpanel/inv/{{$id1->id}}' target="_blank"><span class="glyphicon glyphicon-print"></span></a> 
@endforeach
  ...
  <form  name="ordersave" action="{{action('InvoiceController@resavebuy')}}" onsubmit="return validateForm()" method="post">
  <input type="hidden" name="_token" value="<?= csrf_token() ; ?>" >

  
  <table class="table" style="direction:rtl">
                            <tr>
                             <input type="hidden" name="orderType" value="rebuy">
                            </tr>
                            <tr>
                             <th><span>ID</span></th>
                              @foreach($id as $id1)
