...
function printDiv(divName) {
 ...
 <a href="#!" class="btn-floating orang" onclick="printDiv('printableArea')" value="Print" style="float:right;"><i class="material-icons">print</i></a>
    &nbsp;  &nbsp;  &nbsp;  &nbsp;
 <a href="/adminpanel/products" class="btn-floating orang" style="float:right;"><i class="material-icons">done</i></a>
        ...
        <article>
            ...
            <table    class="table table-bordered" >
                ...
                <th width="30%">اسم المادة</th>
                 <th width="10%">السعر الصافي</th>
                <th width="10%">العدد</th>
                <th width="10%">الوحدة</th>
                <th width="30%">تاريخ الادخال</th>
                ...
                <tr>
                 ...
                 <td width="10%"> {{number_format($product->productNetPrice,2)}}</td>
                 <td width="10%"> {{$product->productQuntity}}</td>
                 <td width="10%"> {{$product->productUnit}}</td>
