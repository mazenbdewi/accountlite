...
#orderBankName,#orderCheckNO,#employeeTD,#customerTD{
display: none ;
...
<input type="hidden" name="orderType" id="orderType" value="sandget"> 
  ...
  <th style="text-align:center"><span>قبضنا من السيد :</span></th>
...
<tr>
 ...
 <tr>
	<td><input type="text" name="fromto" placeholder="من أجل" class='form-control'></td>
