...
@section('content')
  ...
  <div class="modal-content">
      ...
      {!! Form::open(["url"=>"/adminpanel/cars" , "method"=>"POST"]) !!}
...
<a href="/adminpanel/inv/form">العودة الى الفواتير</a>
         ...
         <div class="panel-body">
              <table id="data" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><a href="{{url('/adminpanel/cars/'.$car->id.'/edit')}}">
                  <span class="glyphicon glyphicon-pencil"></span></a>  </td>
                
                   <td> <a href="/adminpanel/cars/{{$car->id}}" class="btn btn-default"> تفاصيل </a></td>
